...
public class ActorRecursos
 {
     private static class Singleton     { private static final ActorRecursos get = new ActorRecursos(); }
     public static ActorRecursos get()  { return Singleton.get; }
     ...
     {
         public HashMap<String,Pixie>listaDeCuerpos = new HashMap<>();
         public HashMap<String,Pixie>listaDeCabezas = new HashMap<>();
         public HashMap<String,Pixie>listaDeYelmos = new HashMap<>();
         public HashMap<String,Pixie>listaDePetos = new HashMap<>();
         public HashMap<String,Pixie>listaDePantalones = new HashMap<>();
         public HashMap<String,Pixie>listaDeGuantes = new HashMap<>();
         public HashMap<String,Pixie>listaDeBotas = new HashMap<>();
         public HashMap<String,Pixie>listaDeHombreras = new HashMap<>();
